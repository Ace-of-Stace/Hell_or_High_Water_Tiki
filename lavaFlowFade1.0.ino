...
#define PIN 6                   // define the pin used to control the LED strip
#define NUM_LEDS 13             // define the number of LEDs in the strip
Adafruit_NeoPixel strip = Adafruit_NeoPixel(NUM_LEDS, PIN, NEO_GRB + NEO_KHZ800);  // create a new NeoPixel object with the specified number of LEDs, pin number, and color format
